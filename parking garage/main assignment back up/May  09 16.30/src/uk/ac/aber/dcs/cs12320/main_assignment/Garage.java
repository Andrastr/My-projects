...
class Garage {
    ...
    //Prints ArrayList "vehicles", used for debugging
    void printVehicles(){
    ...
    void editAttendant(int num){
        ...
        if (tempAttendant!= null){
            if (num == 1){
                removeAttendant(tempAttendant);
            }
            if (num == 2 && !menu){
                changeSalary(tempAttendant);
            }
        } else{
            System.err.println("---ERROR---   Attendant can't be null");
        }
