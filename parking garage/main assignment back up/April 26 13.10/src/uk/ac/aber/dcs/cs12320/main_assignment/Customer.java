...
public class Customer extends Driver {
    ...
    void printReceipt(Customer tempC, Vehicle tempV){
        ...
        System.out.println("| Please keep the receipt on hand |");
        System.out.println("|                                 |");
        System.out.println("|  Date             " + tempC.parkedString(1) + "   |");
        System.out.println("|  Time                   " + tempC.parkedString(2) + "   |");
        System.out.println("+ ------------------------------- +");
        System.out.println("|  RETRIEVAL CODE          " + tempC.getReceiptNum() + "  |");
        System.out.println("+ ------------------------------- +");
        System.out.println("-  Customer ID           | " + tempC.getCustomerNum());
        System.out.println("-  License plate         | " + tempC.getLicensePlate());
        System.out.println("-  Disabled              | " + tempC.getDisabled());
