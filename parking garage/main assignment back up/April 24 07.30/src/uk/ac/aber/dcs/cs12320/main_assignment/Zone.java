...
public class Zone {
    ...
    boolean[] z2Space = new boolean[8];
    boolean[] z3Space = new boolean[6];
    boolean[] z4Space = new boolean[4];
    boolean[] z5Space = new boolean[2];
    ...
    void loadZone()throws IOException{
            ...
            //THERE IS SOMETHING WRONG LOADING, LOOK BACK IN MEME CHANNEL FOR SCREENSHOT
        FileReader fileInput = new FileReader("zone.txt");
        Scanner infile = new Scanner(fileInput);
        infile.useDelimiter(":|\r?\n|\r");
