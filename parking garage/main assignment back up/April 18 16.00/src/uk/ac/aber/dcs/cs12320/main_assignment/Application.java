...
private String filename;
    ...
    private Zone zone = new Zone();
        ...
        //Creates Zone 1, for Standard and higher vehicles (outside)
    Zone zone1 = new Zone("Zone 1", true);
    private boolean[] z1Space = new boolean[100];
        //Creates Zone 2, for longer vehicles (outside)
    Zone zone2 = new Zone("Zone 2", true);
    private boolean[] z2Space = new boolean[50];
        //Creates zone 3, for coaches (outside)
    Zone zone3 = new Zone("Zone 3", true);
    private boolean[] z3Space = new boolean[20];
        //Creates zone 4, for standard size vehicles (inside)
    Zone zone4 = new Zone("Zone 4", false);
    private boolean[] z4Space = new boolean[200];
        //Creates Zone 5, for motorbikes (inside)
    Zone zone5 = new Zone("Zone 5", false);
    private boolean[] z5Space = new boolean[80];
    ...
    private void printMenu(){
        ...
        System.out.println("If you want to retrieve a parked vehicle, please type in '3'");
                            //In reality, this would not be an option on the terminal that the customers has access to
    ...
    private void searchForVehicle(){
        //In the real garage the customer would only have access to a numpad when type in the receipt number
        System.out.println("Please type in the number on your receipt");
        int num = scan.nextInt();
        Vehicle hiddenVehicle = vehicle.searchForVehicle(num);
        if (hiddenVehicle != null){
            System.out.println(hiddenVehicle);
        } else {
    ...
    private void retrieveVehicle(boolean isAttendant){
            ...
            System.out.println("You will now be given a token, pleas enter it by the exit barrier in order to open the barrier");
