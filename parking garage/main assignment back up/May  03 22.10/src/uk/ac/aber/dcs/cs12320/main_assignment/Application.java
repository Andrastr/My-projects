...
//java -cp out/production/Main-Assignment" uk.ac.aber.dcs.cs12320.main_assignment
...
public class Application {
    ...
    private void employeeMenu(){
        ...
        do{
            ...
            System.out.format(format, "3. Get a list of attendants");
            System.out.format(format, "4. Change the rate of a zone");
            System.out.format(format, "5. Print info about the zones");
            System.out.format(format, "6. Display the garage zones");
            System.out.format(format, "7. Go back to the main menu");
            System.out.format(format, "");
            System.out.println("+ ---------------------------------- +");
