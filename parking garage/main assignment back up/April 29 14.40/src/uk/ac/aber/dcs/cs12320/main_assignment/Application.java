...
public class Application {
    ...
    private void registerVehicle(boolean isAttendant){
        ...
        System.out.format(format, "Are you driving a");
        System.out.format(format, "handicapped vehicle?  y/n");
        scan = new Scanner(System.in);
        response = scan.nextLine().toUpperCase();
        do{
            switch (response){
    ...
    /**
     * Generates a receipt for the customer to keep
     *
    ...
    /**
     * Find a free space for the customer to park
     * If no free space is found, customer is turned away
     *
    ...
    /**
     * Allows the customer to type in the given code i order to find and retrieve their vehicle, then calls payment()
     */
